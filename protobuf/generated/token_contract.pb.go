...
var file_token_contract_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x3a, 0x04, 0xa0, 0xbb, 0x18, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_token_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_token_contract_proto_goTypes = []interface{}{
	...
	(*Address)(nil),                                        // 15: client.Address
	(*Hash)(nil),                                           // 16: client.Hash
}
var file_token_contract_proto_depIdxs = []int32{
	15, // 0: client.TokenInfo.issuer:type_name -> client.Address
	0,  // 1: client.TokenInfoList.value:type_name -> client.TokenInfo
	15, // 2: client.GetBalanceInput.owner:type_name -> client.Address
	15, // 3: client.GetBalanceOutput.owner:type_name -> client.Address
	15, // 4: client.GetAllowanceInput.owner:type_name -> client.Address
	15, // 5: client.GetAllowanceInput.spender:type_name -> client.Address
	15, // 6: client.GetAllowanceOutput.owner:type_name -> client.Address
	15, // 7: client.GetAllowanceOutput.spender:type_name -> client.Address
	15, // 8: client.IsInWhiteListInput.address:type_name -> client.Address
	15, // 9: client.GetLockedAmountInput.address:type_name -> client.Address
	16, // 10: client.GetLockedAmountInput.lock_id:type_name -> client.Hash
	15, // 11: client.GetLockedAmountOutput.address:type_name -> client.Address
	16, // 12: client.GetLockedAmountOutput.lock_id:type_name -> client.Hash
	15, // 13: client.GetVirtualAddressForLockingInput.address:type_name -> client.Address
	16, // 14: client.GetVirtualAddressForLockingInput.lock_id:type_name -> client.Hash
	15, // 15: client.TransferFromInput.from:type_name -> client.Address
	15, // 16: client.TransferFromInput.to:type_name -> client.Address
	15, // 17: client.TransferInput.to:type_name -> client.Address
	15, // 18: client.Transferred.from:type_name -> client.Address
	15, // 19: client.Transferred.to:type_name -> client.Address
